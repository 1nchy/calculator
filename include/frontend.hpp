...
class calculator_frontend;

class calculator_frontend : public frontend_interface {
private:
    calculator_frontend(int _in = STDIN_FILENO, int _out = STDOUT_FILENO, int _err = STDERR_FILENO);
public:
    static calculator_frontend& singleton(int _in = STDIN_FILENO, int _out = STDOUT_FILENO, int _err = STDERR_FILENO);
    virtual ~calculator_frontend();
...
private: // special character handler void(char)
    ...
    const std::unordered_map<short, character_handler> _char_handler_map = {
        {(short)extended_char::ec_lf, &calculator_frontend::enter_handler},
        {(short)extended_char::ec_cr, &calculator_frontend::enter_handler},
        {(short)extended_char::ec_ctrld, &calculator_frontend::ctrld_handler},
        {(short)extended_char::ec_esc, &calculator_frontend::esc_handler},
        {(short)extended_char::ec_up, &calculator_frontend::up_arrow_handler},
        {(short)extended_char::ec_down, &calculator_frontend::down_arrow_handler},
        {(short)extended_char::ec_left, &calculator_frontend::left_arrow_handler},
        {(short)extended_char::ec_right, &calculator_frontend::right_arrow_handler},
        {(short)extended_char::ec_home, &calculator_frontend::home_handler},
        {(short)extended_char::ec_end, &calculator_frontend::end_handler},
        {(short)extended_char::ec_del, &calculator_frontend::del_handler},
        {(short)extended_char::ec_back, &calculator_frontend::back_handler},
        {(short)extended_char::ec_tab, &calculator_frontend::tab_handler},
        {(short)extended_char::ec_default, &calculator_frontend::default_handler},
    };
private: // tab
    bool has_tab_next();
    bool has_tab_list();
